...
base_path = os.path.abspath("agents/feedback/models/bertimbau/feedback_treinamento.json")
...
print("Modelo de sentimento finetunado e tokenizador salvos em: ./sentiment-model")
...
loaded_tokenizer = AutoTokenizer.from_pretrained("./sentiment-model")
loaded_model = AutoModelForSequenceClassification.from_pretrained("./sentiment-model")
